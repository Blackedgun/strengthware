...
.container .main .content-2 .pagos_recientes {
  ...
  <div class="container">
      ...
      <div class="navbar">
        ...
        <ul>
          <li><a href="#">
            ...
            <a href="empleado/Horarios.php"><span class="nav-item">Horario</span></a>
          </a>
          </li>
          <li><a href="#">
          ...
          <li><a href="#">
            ...
            <a href="empleado/inventario.php"><span class="nav-item">Inventario</span></a>
          </a>
          </li>
          <li><a href="#">
    ...
    <section class="main">
      ...
      <a href="empleado/Horarios.php"><div class="job_card">
      ...
      <a href="empleado/inventario.php"><div class="job_card">
        <div class="job_details">
          <div class="img">
      ...
      <a href="empleado/facturatable.php"><section class="main">
