...
<body style="background:url(img/Backtwo.jpg)">
  ...
  <div>
    <form class="header__title" action="">
      ...
      <div>
        <a style="color:#707070; height:fit-content; font-size:1.1rem; width:60px; margin-left:400px; background-color:lawngreen;" class='footer__title' href="convert/convertocsvfac.php">CSV</a>
      </div>
      <br>
      <div>
        <a style="color:#fff; height:fit-content; font-size:1.1rem; width:60px; margin-left:400px; background-color:forestgreen;" class='footer__title' href="convert/convertoxmlfac.php">XML</a>
      </div>
    </form>
    <br>
    <br>
    <div class="table__container">
      <table>
        <tr>
          <td>
            <div class="Fetch"><a href="agregarfac.php">Agregar</a></div>
          </td>
          <td>
        ...
        <div class="table__container">
          <table>
            ...
            <tr>
              ...
              <td>
                <form action="eliminarfactura.php" method="POST">
      ...
      <table>
        ...
        ?>
          <tr>
            ...
            <td style="color:#f2f2f2;"><?php echo $mostrarse['fac_pagunit'] ?></td>
            ...
            <td>
              <form action="eliminarfactura.php" method="POST">
                <input type="hidden" name="fac_id" value="<?php echo $mostrarse['fac_id']; ?>">
                <button type="submit" class="footer__title" onclick="return confirm('¿Estás seguro de que quieres eliminar este registro?')">Eliminar</button>
              </form>
            </td>
          </tr>
