...
<body style="background:url(img/Backtwo.jpg)">
  ...
  <div>
    <form class="header__title" action="">
      ...
      <div>
        <a style="color:#707070; height:fit-content; font-size:1.1rem; width:60px; margin-left:400px; background-color:lawngreen;" class='footer__title' href="convert/convertocsvinv.php">CSV</a>
      </div>
      <br>
      <div>
        <a style="color:#fff; height:fit-content; font-size:1.1rem; width:60px; margin-left:400px; background-color:forestgreen;" class='footer__title' href="convert/convertoxmlinv.php">XML</a>
      </div>
    </form>
    <br>
    <br>
    <div class="table__container">
      <table>
        <tr>
          <td>
            <div class="Fetch"><a href="agregarinv.php" class='footer__title'>Agregar</a></div>
          </td>
          <td>
            <div class="Fetch"><a href="Interfaz.php" class='footer__title'>Regresar</a></div>
          </td>
        </tr>
      </table>
    </div>
        ...
        <div class="table__container">
          <table>
            ...
            <tr>
              ...
              <td><a href="forminventario.php?id=<?php echo $row['inv_id']; ?>" class='footer__title'>Modificar</a>
                <br>
                <br>
                <form action="eliminarinv.php" method="POST">
                  <input type="hidden" name="del" value="<?php echo $row['inv_id']; ?>">
      ...
      <table>
        ...
        ?>
          <tr>
            ...
            <td><a href="forminventario.php?id=<?php echo $mostrar['inv_id']; ?>" class='footer__title'>Modificar</a>
              <br>
              <br>
              <form action="eliminarinv.php" method="POST">
                <input type="hidden" name="del" value="<?php echo $mostrar['inv_id']; ?>">
                <button type="submit" class="footer__title" onclick="return confirm('¿Estás seguro de que quieres eliminar este registro?')">Eliminar</button>
              </form>
            </td>
          </tr>
