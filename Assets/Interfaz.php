...
.container .main .content-2 .pagos_recientes {
  ...
  <div class="container">
      ...
      <div class="navbar">
        ...
        <ul>
          ...
          <li><a href="#">
            ...
            <a href="Horarios.php"><span class="nav-item">Horario</span></a>
          </a>
          </li>
          <li><a href="#">
          ...
          <li><a href="#">
            ...
            <a href="inventario.php"><span class="nav-item">Inventario</span></a>
          </a>
          </li>
          <li><a href="#">
    ...
    <section class="main">
      ...
      <a href="Horarios.php"><div class="job_card">
      ...
      <a href="inventario.php"><div class="job_card">
        <div class="job_details">
          <div class="img">
      ...
      <a href="empleados.php"><div class="job_card">
        <div class="job_details">
          <div class="img">
            <img class="zzz" src="img/work.png" alt="">
          </div>
          <div class="text">
            <h2 style="color:#ff9100">Datos de empleados</h2>
            <span></span>
          </div>
        </div>
        <div class="job_salary">
          <h4>Edición</h4>
          <span>Solo personal administrativo</span>
        </div>
      </div></a>
     
      
      <div style="height: 600px; border-radius:2vh;" class="main-top"><a href="facturatable.php"><section class="main">
